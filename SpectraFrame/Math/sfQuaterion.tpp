#pragma once
#ifndef _SPECTRAFRAME_MATH_QUATERION_TPP_
#define _SPECTRAFRAME_MATH_QUATERION_TPP_
...
template <class T>
constexpr sf::Quaterion<T>::Quaterion() : w(static_cast<T>(1)), x(static_cast<T>(0)), y(static_cast<T>(0)), z(static_cast<T>(0)) {}

template <class T>
constexpr sf::Quaterion<T>::Quaterion(T _w, T _x, T _y, T _z) : w(_w), x(_x), y(_y), z(_z) {}

template <class T>
constexpr sf::Quaterion<T>::Quaterion(T radians, const Vector3<T>& axis) {
...
template <class T>
constexpr T sf::Quaterion<T>::length() {
  return sf::sqrt32(w * w + x * x + y * y + z * z);
}

template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::normalize() {
  return *this / length();
}

template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::conjuged() {
  return Quaterion(w, -x, -y, -z);
}

template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::invert() {
  return conjuged() / (w * w + x * x + y * y + z * z);
}

template <class T>
constexpr T sf::Quaterion<T>::dot(const Quaterion& a) {
  return w * a.w + x * a.x + y * a.y + z * a.z;
}

template <class T>
constexpr T sf::Quaterion<T>::length(const Quaterion& a) {
  return sf::sqrt32(a.w * a.w + a.x * a.x + a.y * a.y + a.z * a.z);
}

template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::normalize(const Quaterion& a) {
  return a / length(a);
}

template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::conjuged(const Quaterion& a) {
  return Quaterion(a.w, -a.x, -a.y, -a.z);
}

template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::invert(const Quaterion& a) {
  return conjuged(a) / (a.w * a.w + a.x * a.x + a.y * a.y + a.z * a.z);
}

template <class T>
constexpr T sf::Quaterion<T>::dot(const Quaterion& a, const Quaterion& b) {
  return b.w * a.w + b.x * a.x + b.y * a.y + b.z * a.z;
}

template <class T>
constexpr sf::Vector3<T> sf::Quaterion<T>::operator*(const Vector3<T>& a) {
...
template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::operator*(const Quaterion& a) {
  return {
...
template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::operator*(const T& a) {
  return {
    w * a,
    x * a,
    y * a,
...
template <class T>
constexpr sf::Matrix3<T> sf::Quaterion<T>::toMat3() {
...
template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::toQuat(const Matrix3<T>& mat) {
...
template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::slerp(const Quaterion& a, const Quaterion& b, const T& t) {
  ...
  if (dot - static_cast<T>(1) > static_cast<T>(-SF_G_EPSILON)) {
...
template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::lookRotation(const Vector3<T>& forward, const Vector3<T>& up) {
...
template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::lookAt(const Vector3<T>& forward, const Vector3<T>& up) {
  Matrix3<T> result;

  // Dont negate for left handed coordinates
  result[2] = Vector3<T>::normalize(forward).negate();
  Vector3 right = Vector3<T>::cross(up, forward).normalize();
...
template <class T>
constexpr sf::Quaterion<T> sf::Quaterion<T>::fromEuler(const T& pitch, const T& yaw, const T& roll) {
...
template <class T>
constexpr sf::Vector3<T> sf::Quaterion<T>::toEuler() {
  Vector3<T> angles;
